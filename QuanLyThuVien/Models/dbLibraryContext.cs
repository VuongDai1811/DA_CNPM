...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-FCCOA0V\\SQLEXPRESS;Database=dbLibrary;Integrated Security=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Locations>(entity =>
            {
                ...
                entity.Property(e => e.NamWithType).HasMaxLength(255);
            ...
            modelBuilder.Entity<TblTinTucs>(entity =>
            {
        ...
        public DbSet<QuanLyThuVien.ModelViews.RegisterVM> RegisterVM { get; set; }
    }
}
